...
"""
    ...
    func test_windowsPaths() throws {
        ...
        let paths = [
            // Absolute Paths
            "\(tmpPath.dropFirst())\\testfile",       // C:/Users/...\testfile
            "\(tmpPath.dropFirst())/testfile",        // C:/Users.../testfile
            "\(tmpPath)/testfile",                    // /C:/Users/user/.../testfile
            "\(tmpPath)/testfile",                    // /Users/user/.../testfile
            "\(tmpPath.dropFirst().first!):testfile", // C:testfile
